...
class Audit extends Module
{
    ...
    private $_corePanels = [
        ...
        'audit/request'    => ['class' => 'backend\panels\RequestPanel'],
        'audit/db'         => ['class' => 'backend\panels\DbPanel'],
        'audit/log'        => ['class' => 'backend\panels\LogPanel'],
        'audit/asset'      => ['class' => 'backend\panels\AssetPanel'],
        'audit/config'     => ['class' => 'backend\panels\ConfigPanel'],
        'audit/profiling'  => ['class' => 'backend\panels\ProfilingPanel'],

        // Special other panels
        'audit/error'      => ['class' => 'backend\panels\ErrorPanel'],
        'audit/javascript' => ['class' => 'backend\panels\JavascriptPanel'],
        'audit/trail'      => ['class' => 'backend\panels\TrailPanel'],
        'audit/mail'       => ['class' => 'backend\panels\MailPanel'],
        'audit/extra'      => ['class' => 'backend\panels\ExtraDataPanel'],
        'audit/curl'       => ['class' => 'backend\panels\CurlPanel'],
    ];

    private $_panelFunctions = [];

    /**
     * @var \backend\models\AuditEntry If activated this is the active entry
     */
    private $_entry = null;
